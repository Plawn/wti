...
export const fr: Translations = {
  ...
  specLoader: {
    ...
    dragDropHint: 'Glissez-deposez un fichier ici, ou cliquez pour parcourir',
    urlPlaceholder: 'https://api.example.com/openapi.json',
    loadButton: 'Charger',
    loadingSpec: 'Chargement de la specification...',
    invalidSpec: 'Specification OpenAPI invalide',
    corsError: 'Impossible de recuperer l\'URL. Cela peut etre du aux restrictions CORS. Essayez de telecharger le fichier et de l\'importer.',
    acceptedFormats: 'Accepte les fichiers .json, .yaml, .yml',
    orDivider: 'ou',
  },
};
